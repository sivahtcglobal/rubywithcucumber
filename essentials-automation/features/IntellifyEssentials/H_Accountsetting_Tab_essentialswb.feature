...
Feature: Essential UI Updating New Account settings
  Scenario: Account settings page element verification
      ...
      Then click Account setting tab
      And Verify element in Account setting Page

#  Scenario Outline:Account settings page time Zone Configuration
#      When Config the Avaliable Time zone list <timezone>
#    Examples:
#    |timezone|
#    |Africa/Abidjan|
